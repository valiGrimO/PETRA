...
# MATERIAL
zh_outlinebynormal = bpy.data.materials.new(name='zh_outlinebynormal')
zh_outlinebynormal.use_nodes = True
node_tree0 = zh_outlinebynormal.node_tree
...
if hasattr(texture_coordinate_0, 'location'):
    texture_coordinate_0.location = (-580.0, 229.0)
...
if hasattr(geometry_0, 'location'):
    geometry_0.location = (100.0, 229.0)
...
if hasattr(emission_0, 'location'):
    emission_0.location = (100.0, -17.0)
...
if hasattr(emission_001_0, 'location'):
    emission_001_0.location = (100.0, -133.0)
...
if hasattr(mix_shader_0, 'location'):
    mix_shader_0.location = (270.0, 229.0)
...
if hasattr(material_output_0, 'location'):
    material_output_0.location = (440.0, 229.0)
...
if hasattr(invert_001_0, 'location'):
    invert_001_0.location = (-410.0, 112.0)
...
for obj in selected_objects:
    obj.active_material = zh_outlinebynormal
