...
if hasattr(mix_shader_0, 'location'):
    mix_shader_0.location = (360.0, 0.0)
...
ambient_occlusion_0 = node_tree0.nodes.new('ShaderNodeAmbientOcclusion')
if hasattr(ambient_occlusion_0, 'color'):
    ambient_occlusion_0.color = (0.6079999804496765, 0.6079999804496765, 0.6079999804496765)
if hasattr(ambient_occlusion_0, 'hide'):
    ambient_occlusion_0.hide = False
if hasattr(ambient_occlusion_0, 'inside'):
    ambient_occlusion_0.inside = False
if hasattr(ambient_occlusion_0, 'location'):
    ambient_occlusion_0.location = (0.0, 0.0)
if hasattr(ambient_occlusion_0, 'mute'):
    ambient_occlusion_0.mute = False
if hasattr(ambient_occlusion_0, 'name'):
    ambient_occlusion_0.name = 'Ambient Occlusion'
if hasattr(ambient_occlusion_0, 'only_local'):
    ambient_occlusion_0.only_local = False
if hasattr(ambient_occlusion_0, 'samples'):
    ambient_occlusion_0.samples = 16
if hasattr(ambient_occlusion_0, 'use_custom_color'):
    ambient_occlusion_0.use_custom_color = False
if hasattr(ambient_occlusion_0, 'width'):
    ambient_occlusion_0.width = 140.0
ambient_occlusion_0.inputs[0].default_value = (1.0, 1.0, 1.0, 1.0)
ambient_occlusion_0.inputs[1].default_value = 1.0
ambient_occlusion_0.inputs[2].default_value = (0.0, 0.0, 0.0)
ambient_occlusion_0.outputs[0].default_value = (1.0, 1.0, 1.0, 1.0)
ambient_occlusion_0.outputs[1].default_value = 0.0
...
if hasattr(material_output_0, 'location'):
    material_output_0.location = (540.0, 0.0)
...
node_tree0.links.new(ambient_occlusion_0.outputs[0], emission_0.inputs[0])
