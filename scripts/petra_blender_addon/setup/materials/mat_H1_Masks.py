...
if hasattr(emission_001_0, 'location'):
    emission_001_0.location = (-180.0, 0.0)
...
emission_001_0.inputs[0].default_value = (0.0, 0.0, 1.0, 1.0)
...
if hasattr(emission_0, 'location'):
    emission_0.location = (-180.0, -120.0)
...
emission_0.inputs[0].default_value = (1.0, 0.0, 0.0, 1.0)
...
# LINKS
node_tree0.links.new(emission_001_0.outputs[0], mix_shader_0.inputs[1])
...
# FAKE USER
bpy.data.materials['h1_masks'].use_fake_user = True