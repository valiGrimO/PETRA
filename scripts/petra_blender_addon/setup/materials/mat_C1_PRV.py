...
# MATERIAL
c1_prv = bpy.data.materials.new(name='c1_prv')
c1_prv.use_nodes = True
node_tree0 = c1_prv.node_tree
...
if hasattr(vertex_color_0, 'location'):
    vertex_color_0.location = (-180.0, -60.0)
...
if hasattr(emission_001_0, 'location'):
    emission_001_0.location = (0.0, -180.0)
...
if hasattr(mix_shader_0, 'location'):
    mix_shader_0.location = (180.0, -60.0)
...
if hasattr(material_output_0, 'location'):
    material_output_0.location = (360.0, -60.0)
...
node_tree0.links.new(vertex_color_0.outputs[0], emission_0.inputs[0])
